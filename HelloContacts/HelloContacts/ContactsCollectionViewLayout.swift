...
class ContactsCollectionViewLayout: UICollectionViewLayout {
    ...
    // determines the scrollView's width and height
    ...
    // use this to recalculate layout attributes when the screen size changes (e.g. device orientation)
    ...
    // determines how to layout contents that are currently visible in the scroll view
    ...
    // retrieves the correct layout attributes for the item at the given indexPath
